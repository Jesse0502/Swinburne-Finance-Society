      ...
      <Flex gap="20" mt="32" justify="space-between" alignItems={"start"}>
        <Flex flex="1" alignItems={"center"} gap="9">
            ...
            />
              <Box textAlign={'left'}>
            <Text >
              Think And Grow Rich By Napolean Hill | Goodreads
            </Text>
            <Text
              mt="2"
            //   textDecor={'underline'}
        ...
        <Text flex="1" fontSize={"2xl"} textAlign={'right '}>
          One of the most popular personal development and self-improvement books of all time, Think and Grow Rich has sold over 100M copies worldwide!
        </Text>
      </Flex>
    </Box>
  );
